...
* **Mobile:** Implementación del estado de publicación para las mascotas, permitiendo gestionar estados como activo, reservado y adoptado.
* **Mobile:** Historial clínico del animal integrado en la aplicación, con registro y visualización de datos veterinarios relevantes.
